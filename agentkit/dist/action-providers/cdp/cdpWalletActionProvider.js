...
class CdpWalletActionProvider extends actionProvider_1.ActionProvider {
     ...
     */
    async addLiquidity(walletProvider, args) {
        try {
            const abiCopy = constants_1.ERC20_ABI.map(item => ({
                ...item,
                inputs: [...item.inputs],
     ...
     * @returns A message with the transaction details
     */
    async approveTokens(walletProvider, args) {
        try {
...
Note: Make sure you have enough ETH and tokens before adding liquidity.`,
        schema: schemas_1.AddLiquiditySchema,
    }),
    __metadata("design:type", Function),
    __metadata("design:paramtypes", [wallet_providers_1.CdpWalletProvider, void 0]),
    __metadata("design:returntype", Promise)
], CdpWalletActionProvider.prototype, "addLiquidity", null);
__decorate([
    (0, actionDecorator_1.CreateAction)({
        name: "approve_tokens",
...
- spenderAddress: The address to approve tokens for (router address)`,
        schema: schemas_1.ApproveTokensSchema,
    }),
    __metadata("design:type", Function),
    __metadata("design:paramtypes", [wallet_providers_1.CdpWalletProvider, void 0]),
    __metadata("design:returntype", Promise)
], CdpWalletActionProvider.prototype, "approveTokens", null);
