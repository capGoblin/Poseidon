...
import { DeployContractSchema, DeployNftSchema, DeployTokenSchema, TradeSchema, AddLiquiditySchema, ApproveTokensSchema } from "./schemas";
/**
...
export declare class CdpWalletActionProvider extends ActionProvider<CdpWalletProvider> {
     ...
     */
    addLiquidity(walletProvider: CdpWalletProvider, args: z.infer<typeof AddLiquiditySchema>): Promise<string>;
    /**
     ...
     * @returns A message with the transaction details
     */
    approveTokens(walletProvider: CdpWalletProvider, args: z.infer<typeof ApproveTokensSchema>): Promise<string>;
    /**
